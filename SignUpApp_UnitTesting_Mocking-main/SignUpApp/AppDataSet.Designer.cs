...
namespace SignUpApp {
    ...
    public partial class AppDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string LastName, string FirstName, string Email, int Birth, string Password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow FindByLastName(string LastName) {
            ...
            private void InitClass() {
                ...
                this.columnLastName.Unique = true;
        ...
        public partial class UsersRow : global::System.Data.DataRow {
            ...
            public int Birth {
                get {
                    try {
                        return ((int)(this[this.tableUsers.BirthColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace SignUpApp.AppDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([LastName] = @Original_LastName) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Birth = 1 AND [Birth] IS NULL) OR ([Birth] = @Original_Birth)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([LastName], [FirstName], [Email], [Birth], [Password])" +
                " VALUES (@LastName, @FirstName, @Email, @Birth, @Password);\r\nSELECT LastName, Fi" +
                "rstName, Email, Birth, Password FROM Users WHERE (LastName = @LastName)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [LastName] = @LastName, [FirstName] = @FirstName, [Email] = @Email, [Birth] = @Birth, [Password] = @Password WHERE (([LastName] = @Original_LastName) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Birth = 1 AND [Birth] IS NULL) OR ([Birth] = @Original_Birth)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT LastName, FirstName, Email, Birth, Password FROM Users WHERE (LastName = @LastName)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT LastName, FirstName, Email, Birth, Password FROM dbo.Users";
        ...
        public virtual int Delete(string Original_LastName, string Original_FirstName, string Original_Email, global::System.Nullable<int> Original_Birth, string Original_Password) {
            ...
            if ((Original_Birth.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_Birth.Value));
            }
            else {
        ...
        public virtual int Insert(string LastName, string FirstName, string Email, global::System.Nullable<int> Birth, string Password) {
            if ((LastName == null)) {
            ...
            if ((Birth.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((int)(Birth.Value));
            }
            else {
        ...
        public virtual int Update(string LastName, string FirstName, string Email, global::System.Nullable<int> Birth, string Password, string Original_LastName, string Original_FirstName, string Original_Email, global::System.Nullable<int> Original_Birth, string Original_Password) {
            if ((LastName == null)) {
                throw new global::System.ArgumentNullException("LastName");
            }
            else {
            ...
            if ((Birth.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Birth.Value));
            }
            else {
            ...
            if ((Original_Birth.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Original_Birth.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string Email, global::System.Nullable<int> Birth, string Password, string Original_LastName, string Original_FirstName, string Original_Email, global::System.Nullable<int> Original_Birth, string Original_Password) {
            return this.Update(Original_LastName, FirstName, Email, Birth, Password, Original_LastName, Original_FirstName, Original_Email, Original_Birth, Original_Password);
        }
    }
